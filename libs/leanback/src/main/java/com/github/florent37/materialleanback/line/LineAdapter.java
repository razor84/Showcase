...
public class LineAdapter extends RecyclerView.Adapter {
    ...
    public LineAdapter(Context ctx,@NonNull MaterialLeanBackSettings settings, @NonNull MaterialLeanBack.Adapter adapter, MaterialLeanBack.Customizer customizer) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int type) {
        ...
        switch (type) {
            ...
            case CELL:
                ...
                return new LineViewHolder(view, adapter, settings, customizer, ctx);
            default:
